...
\setbeamertemplate{footline}
{
  ...
  \end{beamercolorbox}
  \begin{beamercolorbox}[wd=.1\paperwidth,ht=2.25ex,dp=1ex,center]{page in head/foot}
    \usebeamerfont{page in head/foot}\insertframenumber{} / \inserttotalframenumber
  \end{beamercolorbox}
  }
  \vskip0pt
}
