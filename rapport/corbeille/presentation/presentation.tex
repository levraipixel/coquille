...
\title{Rapport d'avancement du projet \coquille{}} %% Je ne sais pas si c'est encore un rapport d'avancement ...
...
\begin{frame}
\maketitle
% quand j'aurais réussi à ajouter le dossier des images:
\center
...
\begin{itemize}
  ...
  \item Introduire les mathématiques de classes préparatoires dans Coq. 
    %% Ça ne veut pas dire grand chose, désolé
...
\begin{itemize}
  ...
  %ça ne veut rien dire ! on n'implémente pas des théorèmes
...
\begin{itemize}
  ...
  \item Bibliothèques ordonnées de résultats sur les suites et séries réelles et les suites complexes.
    %les bibli sont "ordonnées" ? Il faut enlever "bibliothèques", il est déjà avant la liste
...
%ça ne compile pas ! Ajoutez les images, bordel
...
\begin{itemize}
    \item Faciliter la coordination des autres groupes de travail %CHECK !
    \item Promouvoir le projet et ses résultats auprès de potentiels utilisateurs. %CHECK !
\end{itemize}
...
\begin{itemize}
    ...
    \item les rapports. %CHECK ! ah ce n'est pas matthieu qui les a fait ?
    \item cette présentation.
    \item des formations HTML et Latex. %QUOI ????
    \item le site internet. %CHECK !
